...
public class InvoiceProductdata {
    ...
    public InvoiceProductdata(){
        
    }
    

    public InvoiceProductdata(String Name, String Batch, String Expdat, String Free, String Billed, String Ptr, String Pts, String Mrp, String Tax, String Taxamt, String Pdvalue, String Mrpvalue) {
        this.Name = Name;
        this.Batch = Batch;
        this.Expdat = Expdat;
        this.Free = Free;
